...
Our two independent samples are evenly distributed, with one occurring in the train data, and one in the test data. This is still not an ideal scenario, as those outliers could unfairly influence the model, but we'll continue and 
