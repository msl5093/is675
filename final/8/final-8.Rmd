...
To begin we will need to reassing the numeirc features within the iris data frame to a matrix. Specifically the data structure we need is a distance/dissimilarity matrix. This is simply a matrix that contains the distances between the elements of a set. 
